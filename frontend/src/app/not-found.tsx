  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 px-4 py-12">
      <div className="w-full max-w-md text-center">
        ...
        <div className="mt-10 rounded-xl border border-neutral-200 bg-neutral-50 p-4 text-left">
          ...
          <ul className="mt-2 space-y-1.5 text-sm">
            ...
            <li>
              <Link href="/track" className="text-green-600 hover:underline">
                Track a Complaint
              </Link>
            </li>
            <li>
              <Link href="/report" className="text-green-600 hover:underline">
                File a Complaint
              </Link>
            </li>
          </ul>
