...
const EVENT_TYPE_COLORS: Record<string, string> = {
  ...
  TICKET_CLOSED: "bg-neutral-50 text-foreground",
...
export default function AuditLogsPage() {
  ...
  const fetchEvents = useCallback(async () => {
    ...
    try {
      ...
      if (ticketCodeSearch.trim())
        params.set("ticketCode", ticketCodeSearch.trim());
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={fetchEvents}
            disabled={loading}
            className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-neutral-50 px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-neutral-50 disabled:opacity-60"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-green-600 px-3 py-2 text-sm font-semibold text-white transition-colors hover:bg-green-700"
          >
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-border bg-neutral-50 py-2 pl-9 pr-3 text-sm outline-none transition-colors focus:border-green-600 focus:ring-2 focus:ring-green-600/20"
            />
          </div>
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-lg border border-border bg-neutral-50 px-3 py-2 text-sm outline-none focus:border-green-600 focus:ring-2 focus:ring-green-600/20"
            >
              {EVENT_TYPES.map((t) => (
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1 rounded-lg border border-border bg-neutral-50 px-3 py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-neutral-50 disabled:opacity-50 disabled:cursor-not-allowed"
            >
