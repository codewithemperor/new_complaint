...
var Y = class extends Error {
    constructor(e, { clientVersion: r }){
        super(e), this.name = "PrismaClientValidationError", this.clientVersion = r;
    }
    get [Symbol.toStringTag]() {
...
var Ue = class extends ie {
    constructor(e, r){
        super(e, _(r, !1)), this.name = "InvalidDatasourceError", this.code = "P6001";
    }
};
...
var pt = class extends ie {
    constructor(e){
        super("This request must be retried", _(e, !0)), this.name = "ForcedRetryError", this.code = "P5001";
    }
};
...
var qe = class extends ie {
    constructor(e, r){
        super(e, _(r, !1)), this.name = "NotImplementedYetError", this.code = "P5004";
    }
};
...
var Ve = class extends V {
    constructor(e){
        super("Schema needs to be uploaded", _(e, !0)), this.name = "SchemaMissingError", this.code = "P5005";
    }
};
...
var Mn = "This request could not be understood by the server", Vt = class extends V {
    constructor(e, r, n){
        super(r || Mn, _(e, !1)), this.name = "BadRequestError", this.code = "P5000", n && (this.code = n);
    }
};
...
var Bt = class extends V {
    constructor(e, r){
        super("Engine not started: healthcheck timeout", _(e, !0)), this.name = "HealthcheckTimeoutError", this.code = "P5013", this.logs = r;
    }
};
...
var $t = class extends V {
    constructor(e, r, n){
        super(r, _(e, !0)), this.name = "EngineStartupError", this.code = "P5014", this.logs = n;
    }
};
...
var jt = class extends V {
    constructor(e){
        super("Engine version is not supported", _(e, !1)), this.name = "EngineVersionNotSupportedError", this.code = "P5012";
    }
};
...
var Ln = "Request timed out", Qt = class extends V {
    constructor(e, r = Ln){
        super(r, _(e, !1)), this.name = "GatewayTimeoutError", this.code = "P5009";
    }
};
...
var bu = "Interactive transaction error", Gt = class extends V {
    constructor(e, r = bu){
        super(r, _(e, !1)), this.name = "InteractiveTransactionError", this.code = "P5015";
    }
};
...
var Eu = "Request parameters are invalid", Jt = class extends V {
    constructor(e, r = Eu){
        super(r, _(e, !1)), this.name = "InvalidRequestError", this.code = "P5011";
    }
};
...
var Fn = "Requested resource does not exist", Wt = class extends V {
    constructor(e, r = Fn){
        super(r, _(e, !1)), this.name = "NotFoundError", this.code = "P5003";
    }
};
O(Wt, "NotFoundError");
u();
...
var Nn = "Unknown server error", mt = class extends V {
    constructor(e, r, n){
        super(r || Nn, _(e, !0)), this.name = "ServerError", this.code = "P5006", this.logs = n;
    }
};
O(mt, "ServerError");
u();
...
var Un = "Unauthorized, check your connection string", Kt = class extends V {
    constructor(e, r = Un){
        super(r, _(e, !1)), this.name = "UnauthorizedError", this.code = "P5007";
    }
};
...
var qn = "Usage exceeded, retry again later", Ht = class extends V {
    constructor(e, r = qn){
        super(r, _(e, !0)), this.name = "UsageExceededError", this.code = "P5008";
    }
};
...
${e}`, _(r, !0)), this.name = "RequestError", this.code = "P5010";
    }
};
O(Yt, "RequestError");
