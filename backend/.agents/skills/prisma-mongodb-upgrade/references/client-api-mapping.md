...
| `create` / `update` / `upsert` / `delete` / `updateMany` / `deleteMany`                                                                               | `create` / `update` / `upsert` / `delete` / `updagreenl` / `delegreenl` on `db.orm.<collection>`                                                                                                                                                                                                                              | See Prisma Next's `prisma-next-queries` skill                              |
